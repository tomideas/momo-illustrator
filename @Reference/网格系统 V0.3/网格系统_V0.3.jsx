...
var isSync = syncCheck.value;
rowGutter.enabled = !isSync;
if (isSync) { 
rowGutter.text = colGutter.text;
}
}
...
var DEFAULT_STROKE_COLOR = rgb(170, 170, 170);
...
var dlg = new Window("dialog", "\u7f51\u683c\u7cfb\u7edf (Grid System) V0.3");
...
var colGutterLabel = colGroup.add("statictext", undefined, "\u95f4\u8ddd");
colGutterLabel.preferredSize = [30, 20];
...
var rowGutterLabel = rowGroup.add("statictext", undefined, "\u95f4\u8ddd");
rowGutterLabel.preferredSize = [30, 20];
...
var syncCheck = rowGroup.add("checkbox", undefined, "");
syncCheck.value = true;
syncCheck.preferredSize = [20, 20];
rowGutter.enabled = !syncCheck.value;
if (syncCheck.value) { 
rowGutter.text = colGutter.text;
}
...
var gutterLabel = divGroup.add("statictext", undefined, "\u95f4\u8ddd");
gutterLabel.preferredSize = [30, 20];
...
var livePreview = previewGroup.add("checkbox", undefined, "\u5b9e\u65f6\u9884\u89c8");
livePreview.value = true;
livePreview.alignment = ["left", "center"];
...
var previewBtn = buttonGroup.add("button", undefined, "\u91cd\u7f6e");
...
copyrightGroup.alignment = ["center", "center"];
copyrightGroup.margins = [0, 8, 0, 0];
var copyrightText = copyrightGroup.add("statictext", undefined, "\xa9 2026 canfei. \u706b\u5c71\u5b57\u578b / hstype.com");
copyrightText.alignment = ["center", "center"];
copyrightText.graphics.font = ScriptUI.newFont("Arial", "REGULAR", 8);
copyrightText.graphics.foregroundColor = copyrightText.graphics.newPen(copyrightText.graphics.PenType.SOLID_COLOR, [0.6, 0.6, 0.6], 1);
...
attachSpin(colGutter, {min: 0, onAfter: function (v) {
if (syncCheck.value) { 
rowGutter.text = String(v);
}
}, step: 1});
...
livePreview.onClick = onAnyChange;
updateUnitLabels();
var _busy = false;
var _ts = 0;
dlg.show();
